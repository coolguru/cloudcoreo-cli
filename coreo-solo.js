...
program
    ...
    .action(function(options){
	    ...
	    helper.git_cmd('.', activeConfig.privateKeyMaterial, "git add . --all 2>&1; git commit -m 'running solo' 2>&1;", {}, [], function(err, commitOut) {
                helper.git_cmd('.', activeConfig.privateKeyMaterial, "git push ccsolo master 2>&1", {}, [], function(err, pushOut) {
