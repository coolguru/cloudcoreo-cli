...
module.exports.fixConfigYaml = function(topLevelDir, done) {
    ...
    this.parseConfigVariablesFiles(topLevelDir, function(err, variables){
...
module.exports.parseConfigVariablesFiles = function(basedir, callback){
...
generateVariablesFile = function(startdir, showMissing, callback){
    var variables = this.parseConfigVariablesFiles(startdir, function(err, data){});
